...
void pgfe_sha224_encode_multiple(pgfe_encode_t output[], const size_t out_length, const size_t input_c, ...);

// SHA256
void pgfe_sha256_encode(
    const pgfe_encode_t data[], const size_t length, pgfe_encode_t output[], const size_t out_length
);
...
void pgfe_sha256_encode_multiple(pgfe_encode_t output[], const size_t out_length, const size_t input_c, ...);

// SHA384
void pgfe_sha384_encode(
    const pgfe_encode_t data[], const size_t length, pgfe_encode_t output[], const size_t out_length
);
...
void pgfe_sha384_encode_multiple(pgfe_encode_t output[], const size_t out_length, const size_t input_c, ...);

// SHA512
void pgfe_sha512_encode(
    const pgfe_encode_t data[], const size_t length, pgfe_encode_t output[], const size_t out_length
);
...
void pgfe_sha512_encode_multiple(pgfe_encode_t output[], const size_t out_length, const size_t input_c, ...);

// SHA512-224

void pgfe_sha512_224_encode(
    const pgfe_encode_t data[], const size_t length, pgfe_encode_t output[], const size_t out_length
);

void pgfe_sha512_224_encode_f(FILE *fp, pgfe_encode_t output[], const size_t length);
...
void pgfe_sha512_224_encode_multiple(pgfe_encode_t output[], const size_t out_length, const size_t input_c, ...);

// SHA512-256

void pgfe_sha512_256_encode(
    const pgfe_encode_t data[], const size_t length, pgfe_encode_t output[], const size_t out_length
);

void pgfe_sha512_256_encode_f(FILE *fp, pgfe_encode_t output[], const size_t length);
...
void pgfe_sha512_256_encode_multiple(pgfe_encode_t output[], const size_t out_length, const size_t input_c, ...);
