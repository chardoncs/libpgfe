...
#include "libpgfe/core/bases/base32.h"
...
inline pgfe_encode_t decode_base32_char(char base32_c) {
    pgfe_encode_t o;
...
inline pgfe_encode_t decode_base32hex_char(char base32_c) {
    pgfe_encode_t o;
...
inline size_t pgfe_encode_base32(const pgfe_encode_t input[], size_t input_length, char cs_out[]) {
    return encode_base_generic(PGFE_BASE_PARAMS(BASE32), BASE32_ALPHABET, input, input_length, cs_out);
}

inline size_t pgfe_encode_base32hex(const pgfe_encode_t input[], size_t input_length, char cs_out[]) {
    return encode_base_generic(PGFE_BASE_PARAMS(BASE32), BASE32_ALPHABET_EXTHEX, input, input_length, cs_out);
}
