...
static const pgfe_word_t H0_224[] = {
...
static const pgfe_word_t H0_256[] = {
...
inline void pgfe_sha512_224_digest(struct pgfe_sha512_ctx *ctx, pgfe_encode_t output[]) {
    sha384n512_digest(ctx, output, PGFE_SHA512_224_DIGEST_SIZE);
}

FRONTEND_GEN2(sha512_256);
FRONTEND_GEN2_DEFAULT(sha512_256, SHA512_256);

inline void pgfe_sha512_256_init(struct pgfe_sha512_ctx *ctx) {
    pgfe_sha512_generic_init(ctx, H0_256);
}
...
inline void pgfe_sha512_256_digest(struct pgfe_sha512_ctx *ctx, pgfe_encode_t output[]) {
    sha384n512_digest(ctx, output, PGFE_SHA512_256_DIGEST_SIZE);
}
